...
const DEFAULT_SPECIALTY_PROTOCOLS: DefaultProtocolSeed[] = [
  {
    folderName: 'Gastroenterologia',
    iconKey: 'gastroenterology',
    color: '#f97316',
    protocolName: 'Protocolo Exemplo - Gastroenterologia',
  ...
  {
    folderName: 'Nefrologia e Urologia',
    iconKey: 'water_drop',
    color: '#0ea5e9',
    protocolName: 'Protocolo Exemplo - Nefrologia e Urologia',
  ...
  {
    folderName: 'Pneumologia',
    iconKey: 'air',
    color: '#06b6d4',
    protocolName: 'Protocolo Exemplo - Pneumologia',
  ...
  {
    folderName: 'Cardiologia',
    iconKey: 'cardiology',
    color: '#ef4444',
    protocolName: 'Protocolo Exemplo - Cardiologia',
  ...
  {
    folderName: 'Neurologia',
    iconKey: 'neurology',
    color: '#8b5cf6',
    protocolName: 'Protocolo Exemplo - Neurologia',
  ...
  {
    folderName: 'Oncologia',
    iconKey: 'biotech',
    color: '#ec4899',
    protocolName: 'Protocolo Exemplo - Oncologia',
