...
export const doencaValvarMitralDegenerativaRecord: DiseaseRecord = {
  ...
  quickDecisionStrip: [
    ...
    'Pimobendan: priorizar cápsulas/comprimidos de especialidade veterinária; evitar fórmulações líquidas ou géis manipulados com biodisponibilidade duvidosa — muitos serviços administram em jejum (~1 h antes da refeição).',
