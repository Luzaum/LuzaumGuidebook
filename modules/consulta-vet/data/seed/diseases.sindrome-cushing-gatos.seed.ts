...
export const sindromeCushingGatosRecord: DiseaseRecord = {
  ...
  references: [
    ...
    { id: 'ref-cush-fel-nelson-2020', citationText: 'Nelson RW, Couto CG. Small Animal Internal Medicine. 6th ed. 2020. Cap. 50.', sourceType: 'Livro-texto', evidenceLevel: 'Referencia clinica' },
