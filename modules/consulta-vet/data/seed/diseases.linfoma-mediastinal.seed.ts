...
export const linfomaMediastinalRecord: DiseaseRecord = {
  ...
  pathogenesisTransmission: {
    cascata: [
      '1. Transformação clonal e expansão tímica: Desregulação genética ou integração proviral por FeLV em timócitos corticais ou linfonodos mediastinais, resultando em escape da seleção tímica negativa e proliferação clonal descontrolada de linfócitos T imaturos (frequentemente com fenótipo CD4+CD8+ duplo-positivo).',
      '2. Ocupação progressiva do espaço mediastinal cranial: O crescimento exponencial da massa linfoide no compartimento inextensível do mediastino cranial desloca dorsalmente a traqueia torácica e esôfago e empurra a silhueta cardíaca caudalmente.',
      '3. Obstrução vascular e linfática torácica: O tumor comprime circunferencialmente a veia cava cranial e o ducto torácico, aumentando a pressão hidrostática retrógrada e bloqueando a drenagem linfática pleural, culminando em efusão pleural (transudato modificado, exsudato neoplásico ou quilotórax) e síndrome da veia cava cranial (síndrome precaval).',
      '4. Colapso mecânico pulmonar e disfunção ventilatória: A combinação de massa sólida volumosa e efusão pleural bilateral impõe grave restrição à expansão pulmonar, provocando atelectasia compressiva dos lobos pulmonares craniais e hipoxemia por desequilíbrio V/Q severo.',
      '5. Ativação do eixo paraneoplásico hipercalcêmico: Em cães (69,1% dos casos; Machado et al., 2026), os linfócitos T neoplásicos secretam quantidades maciças de peptídeo relacionado ao paratormônio (PTHrP) e citocinas osteoclásticas, desencadeando hipercalcemia grave, nefrotoxicidade e poliúria/polidipsia compensatória.',
      '6. Disseminação sistêmica e desfecho: Na ausência de intervenção quimioterápica rápida, o paciente evolui para óbito por asfixia restritiva, colapso circulatório por tamponamento venoso cranial ou lesão renal aguda por hipercalcemia e síndrome de lise tumoral.',
    ],
    transmissao:
      'Neoplasia clonal hematolinfoide não transmissível por contato horizontal direto entre cães. Na espécie felina, a forma associada ao vírus da leucemia felina (FeLV) decorre da transmissão retroviral horizontal por saliva, mordeduras, lambedura mútua ou fômites compartilhados, além de transmissão vertical transplacentária e lactogênica.',
  },
  pathophysiology: {
    mecanismosOncogenicosEImunofenotipo:
      'A fisiopatologia celular do linfoma mediastinal reflete a proliferação descontrolada de linfócitos T bloqueados em estágios precoces da ontogenia tímica. Em condições fisiológicas, o microambiente tímico cortical e medular direciona o rearranjo dos genes dos receptores de células T (TCR) e a expressão alternada de CD4 e CD8. No linfoma mediastinal canino, aproximadamente 95,6% das neoplasias são de linhagem T (Machado et al., 2026), frequentemente originárias de clones com diferenciação parcial que mantêm a expressão de marcadores tímicos imaturos. Em felinos, 67% dos linfomas mediastinais expressam simultaneamente CD4 e CD8 (Bernardi et al., 2020), demonstrando que o clone transformado preserva a assinatura imunofenotípica cortical tímica sem que isso implique benignidade ou diagnóstico de timoma. Esse clone em rápida replicação apresenta altíssima taxa mitótica e grande fragilidade de membrana, o que fundamenta tanto sua extrema quimiossensibilidade a protocolos multiagente quanto a predisposição crítica à lise celular espontânea ou induzida.',
    figuraRadiografiaToracica: figura2RadiografiaToracica,
    figuraTomografiaComputadorizada: figura3TomografiaComputadorizada,
    figuraCitologiaEImunocitoquimica: figura4CitologiaEImunocitoquimica,
    repercussoesHemodinamicasEVasculares:
      'O confinamento anatômico do mediastino cranial transforma a expansão do linfoma em uma síndrome compressiva multissistêmica. A veia cava cranial e os grandes troncos venosos braquiocefálicos possuem paredes delgadas e baixa pressão transmural intraluminal, sendo facilmente comprimidos e envolvidos pela massa tumoral sólida (Reeve et al., 2020). O aumento da pressão venosa retrógrada resultante reduz drasticamente o retorno venoso do segmento cranial do animal, gerando edema em manto facial, cervical e dos membros torácicos (síndrome precaval clássica), acompanhado de distensão e estase jugular bilateral. Paralelamente, o bloqueio mecânico do ducto torácico em sua desembocadura venosa impede o escoamento quilífero, extravasando linfa rica em triglicérides e quilomícrons para a cavidade pleural e determinando quilotórax secundário neoplásico.',
  },
