...
export const fistulaPerianalFurunculoseAnalRecord: DiseaseRecord = {
      ...
      pillars: [
        {
          title: 'Definição',
          body:
            'Inflamação crônica da região perianal com úlcerações e tratos drenantes; o eixo central é imunomediado, com infecção secundária como agravante.',
    ...
    etiology: {
      mecanismoImune:
        'Inflamação crônica imunomediada na interface pele–mucosa–esfíncter perianal destrói arquitetura tecidual normal, gerando úlcerações e tratos fistulosos (Nelson & Couto, 6ª ed.).',
      genetica:
  ...
  fatoresAgravantes: [
    ...
    pathogenesisTransmission: {
      patogenese: [
        ...
        'A inflamação prolongada destrói a integridade da barreira: surgem úlcerações, tratos drenantes e cavidades fistulosas ao redor do ânus.',
    ...
    pathophysiology:
      'A região anal integra pele perianal, mucosa retal terminal, esfíncteres e sacos anais. Inflamação imune persistente na interface pele–mucosa–esfíncter destrói integridade, úlcera e drena de forma desorganizada.\n\n' +
      'Dor intensa — inervação rica; úlceração profunda.\n' +
        ...
        findings: [
          {
            ...
            mechanism:
              'Úlcerações drenantes e inflamação local provocam dor e prurido inflamatório contínuos.',
        ...
        findings: [
          {
            ...
            mechanism:
              'Dor ao evacuar e úlceração mucosa/cutânea sangram com facilidade; fibrose crônica estreita canal.',
