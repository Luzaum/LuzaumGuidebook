...
export const PUBLIC_CATALOG_MEDICATION_CARD_STUBS: MedicationRecord[] = [
  ...
  medicationListCard({
    ...
    species: ['dog', 'cat'],
    category: 'respiratorio',
    tags: ['Corticosteroide inalatório', 'Controlador', 'Asma felina', 'Pneumologia'],
  ...
  medicationListCard({
    ...
    species: ['dog', 'cat'],
    category: 'respiratorio',
    tags: ['Corticosteroide inalatório', 'LABA', 'Manutenção', 'Pneumologia'],
  ...
  medicationListCard({
    ...
    species: ['dog', 'cat'],
    category: 'respiratorio',
    tags: ['Broncodilatador', 'Resgate', 'SABA', 'Crise asmática', 'Pneumologia'],
  ...
  medicationListCard({
    ...
    species: ['dog', 'cat'],
    category: 'respiratorio',
    tags: ['Antimuscarínico', 'Broncodilatador complementar', 'Pneumologia'],
