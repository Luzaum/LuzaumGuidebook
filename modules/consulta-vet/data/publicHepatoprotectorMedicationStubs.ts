...
export const PUBLIC_HEPATOPROTECTOR_MEDICATION_CARD_STUBS: MedicationRecord[] = [
  medicationListCard({
    ...
    indications: ['Suporte antioxidante adjuvante em hepatopatias e colestase quando ha plano diagnóstico e tratamento da causa.'],
  }),
  medicationListCard({
    ...
    indications: ['Suporte nutricional adjuvante em hepatopatias, convalescenca e uso de fármacos potencialmente hepatotoxicos.'],
  }),
  medicationListCard({
