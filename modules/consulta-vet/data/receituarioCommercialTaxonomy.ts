...
export const RECEITUARIO_COMMERCIAL_SUBCLASS_LABELS: Record<CommercialMedicationSubclass, string> = {
  ...
  endocrine_sglt2: 'Inibidores de SGLT2 (antidiabéticos orais)', endocrine_lipid_lowering: 'Hipolipemiantes',
  ...
  oncologic_chemotherapy: 'Quimioterápicos / agentes citotóxicos', emergency_thrombopoietin: 'Agonistas de TPO / Trombopoiese (PTI)',
...
export const RECEITUARIO_SUBCLASSES_BY_CLASS: Record<CommercialMedicationClass, CommercialMedicationSubclass[]> = {
  ...
  reproductive: ['repro_antigalactogenic'], oncologic: ['oncologic_tki', 'oncologic_chemotherapy', 'emergency_thrombopoietin'], emergency: ['sedative_anesthetic', 'endocrine_diagnostic', 'emergency_thrombopoietin'],
