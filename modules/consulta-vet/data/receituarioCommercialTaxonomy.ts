...
export const RECEITUARIO_COMMERCIAL_SUBCLASS_LABELS: Record<CommercialMedicationSubclass, string> = {
  ...
  gi_hepatobiliary: 'Hepatobiliares', gi_orexigenic: 'Orexígenos', analgesic_opioid_combo: 'Analgésicos multimodais',
...
export const RECEITUARIO_SUBCLASSES_BY_CLASS: Record<CommercialMedicationClass, CommercialMedicationSubclass[]> = {
  ...
  infectious: ['infectious_antifungal', 'infectious_antibiotic'], analgesic: ['analgesic_opioid_combo', 'neuro_pain', 'sedative_anesthetic'],
