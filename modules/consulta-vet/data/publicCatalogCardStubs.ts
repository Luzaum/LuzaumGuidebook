...
export const PUBLIC_CATALOG_DISEASE_CARD_STUBS: DiseaseRecord[] = [
  ...
  diseaseListCard({
    ...
    synonyms: [
      'Linfoma cutâneo canino e felino',
    ...
    quickSummary:
      'Neoplasia linfoide cutânea heterogênea dividida biologicamente em epiteliotrópica (eCTCL: T CD3+ citotóxico, micose fungoide, Sézary) e não epiteliotrópica (NECL: T ou B dérmico/subcutâneo). Frequentemente mimetiza dermatite atópica, piodermite ou doenças imunomediadas (variante 2026 com dermatite de interface citotóxica; Smith et al.). Histopatologia com biópsia representativa (≥3 sítios, sem esmagamento) e imunofenotipagem (CD3, CD20) definem a linhagem. Doença solitária responde à cirurgia ou radioterapia com longo controle local (Withrow; Chan et al., 2018). Doença difusa canina tem na lomustina (CCNU, 60–70 mg/m²) a melhor base histórica (ORR ~80%, duração mediana ~94 dias; Risbon et al., 2006; Nelson & Couto). No gato, atentar para linfoma tarsal, linfoma em sítio de injeção e o mimetizador indolente da linfocitose cutânea (Vet Sci 2022).',
  }),  diseaseListCard({
    id: 'disease-linfoma-mediastinal-caes-gatos',
    slug: 'linfoma-mediastinal-caes-gatos',
    title: 'Linfoma Mediastinal',
    synonyms: [
      'Linfoma mediastinal cranial',
      'Linfoma T tímico',
      'Linfossarcoma mediastinal',
      'Massa mediastinal linfoide',
      'Feline mediastinal lymphoma',
      'Canine mediastinal lymphoma',
    ],
    species: ['cat', 'dog'],
    category: 'oncologia',
    categories: ['urgencia-emergencia', 'pneumologia', 'medicina-felina'],
    tags: [
      'Linfoma',
      'Mediastino',
      'Timo',
    ...
    quickSummary:
      'Neoplasia linfoide maligna intratorácica primária que acomete timo e linfonodos mediastinais craniais. Em cães, caracteriza-se por 95,6% de linhagem T e 69,1% de hipercalcemia de malignidade com PU/PD (Machado et al., 2026). Em gatos, manifesta-se tipicamente como emergência respiratória restritiva com efusão pleural bilateral e tórax cranial pouco compressível. Toracocentese imediata deve preceder radiografias em pacientes instáveis. Diferencial crítico com timoma: linfoma é primariamente quimiossensível, e não cirúrgico. Na citometria felina, até 67% dos linfomas são CD4+CD8+ duplo-positivos (Bernardi et al., 2020), invalidando a regra canina clássica. Tratamento com quimioterapia multiagente sistêmica (CHOP / COP / LOP), prevenção vigorosa da síndrome de lise tumoral e contraindicação absoluta ao uso prévio isolado de corticosteroides.',
  }),
  ...
  diseaseListCard({
    ...
    synonyms: [
      'Empiema pleural',
      'Empiema torácico',
      'Pleurite séptica purulenta',
      'Pyothorax',
      'Septic pleural effusion',
    ],
    species: ['cat', 'dog'],
    category: 'urgencia-emergencia',
    categories: ['urgencia-emergencia', 'pneumologia', 'infectologia', 'terapia-intensiva', 'cirurgia'],
    tags: [
      'Piotórax',
      'Empiema',
      'Toracocentese',
    ...
    quickSummary:
      'Infecção bacteriana supurativa de espaço fechado com exsudato séptico fibrinocelular na cavidade pleural. Gatos apresentam predominantemente infecções polimicrobianas e anaeróbios estritos (73%) decorrentes de traumas penetrantes por mordedura (76%; Johnson et al., 2023), enquanto cães associam-se a corpos estranhos vegetais migratórios (espiguetas) e abscessos. Regra de ouro na emergência: oxigenoterapia passiva e toracocentese de alívio prévia à radiografia em animais dispneicos para prevenir colapso fatal. Padrão ouro diagnóstico na citopatologia: neutrófilos degenerados com bactérias intracelulares fagocitadas. O tripé terapêutico inegociável compreende: suporte intensivo, controle mecânico de foco (toracostomia com tubo 6 F wire-guided em felinos com apenas 4% de complicações; Heier et al., 2022) com lavagem pleural salina (recuperação ≥ 75%) e antibioticoterapia parenteral de quatro quadrantes (ampicilina-sulbactam associada a fluoroquinolona, respeitando o limite estrito de 5 mg/kg/dia para enrofloxacina em felinos para prevenir retinotoxicidade irreversível). Casos refratários ou com corpos estranhos exigem TC contrastada precoce e intervenção cirúrgica desbridante (Eiras-Diaz et al., 2021).',
  }),
  ...
  diseaseListCard({
    ...
    quickSummary:
      'Acúmulo de quilo na cavidade pleural secundário a hipertensão linfática ou venosa, com quebra de paradigma etiológico em felinos por Severac et al. (2026): cardiopatia é a causa líder em 57% dos gatos (LA:Ao mediano 2,4 vs < 1,4), superando causas idiopáticas (31%) e neoplasias (9%). Em cães, predomina etiologia idiopática (70%, com forte risco em Afghan Hounds). Regra de ouro emergencial: toracocentese diagnóstica e terapêutica antes da radiografia para prevenir parada cardiorrespiratória por estresse. Padrão ouro confirmatório: triglicerídeos pleurais superiores aos séricos (TGpleural > TGsérico); relação colesterol:triglicerídeo < 1 apresenta até 50% de falso-positivos em gatos (Waddle & Giger). O quilo espolia proteínas, linfócitos T e lipídios, induzindo hipoalbuminemia, linfopenia e caquexia linfática, além de hiponatremia e hipercalemia paradoxal pós-drenagens repetidas. A complicação tardia mais letal é a pleurite fibrosante restritiva (mortalidade > 80%). A revisão sistemática GRADE de Reeves et al. (2020) desmistifica a espera cega de 3 meses sob dieta e rutina (esta com evidência anedótica n=4 em Thompson 1999); refratariedade após 7 a 14 dias impõe encaminhamento cirúrgico precoce para ligadura do ducto torácico (TDL) e pericardiectomia.',
  }),
  ...
  diseaseListCard({
    ...
    quickSummary:
      'Disfunção neuromuscular e dilatação irreversível do cólon. No felino, predomina a forma idiopática com perda contrátil intrínseca do músculo liso (Washabau & Stalis, 1996) e remodelamento temporal aos 6 meses (Abdelbaset-Ismail et al., 2022). No cão, a dilatação quase sempre responde a causas mecânicas secundárias reversíveis (Tzimtzimis et al., 2019). Em felinos em esforço, palpar a bexiga antes do cólon para descartar obstrução uretral. Razão radiográfica MCD/L5 >1,48 confirma megacólon (Se 77%, Sp 85%; Trevail et al., 2011). Tratamento: hidratação venosa prévia, enemas mornos seguros (proibição absoluta de fosfato em gatos), PEG 3350 titulado, cisaprida após desobstrução e dieta de baixo resíduo na atonia motora. Colectomia subtotal com preservação da junção ileocecocólica é o padrão ouro na falência médica crônica (Grossman et al., 2021).',
  }),
  diseaseListCard({
...
export const PUBLIC_CATALOG_MEDICATION_CARD_STUBS: MedicationRecord[] = [
  ...
  medicationListCard({
    ...
    isControlled: true,
    tradeNames: [
      'Cronidor® 12 mg, 40 mg e 80 mg (Agener União — Uso Veterinário Exclusivo)',
      ...
      'Tramadol Genérico Gotas 100 mg/mL e Comprimidos 50 mg (Teuto, Medley, EMS)',
    ],
    pharmacologicClass: 'Analgésico de ação mista; agonista fraco µ-opioide e inibidor da recaptação de serotonina e noradrenalina',
    species: ['dog', 'cat'],
    ...
    indications: [
      'Analgesia perioperatória e pós-cirúrgica aguda em cães e gatos (multimodal parenteral).',
      'Analgesia em felinos domésticos para dor crônica musculoesquelética (osteoartrite).',
      'Componente adjuvante em protocolos multimodais para dor crônica oncológica e neuropática.',
      'Controle de dor visceral aguda hospitalar associada a pancreatite ou trauma.',
    ],
  }),
  medicationListCard({
    ...
    isControlled: false,
    tradeNames: [
      'Ampicilina Sódica + Sulbactam Sódico 1,5 g e 3 g Pó Injetável (ABL, Fresenius, Eurofarma)',
      'Unasyn® 1,5 g e 3 g Injetável (Pfizer)',
    ],
    pharmacologicClass: 'Antibacteriano bactericida; aminopenicilina potencializada por inibidor suicida de beta-lactamases (2:1)',
    species: ['dog', 'cat'],
    category: 'infectologia',
    tags: [
      'Ampicilina',
    ...
    indications: [
      'Pneumonia bacteriana grave ou pneumonia aspirativa mista em cães e gatos hospitalizados.',
      'Manejo hospitalar multimodal do piotórax canino e felino associado a drenagem torácica ativa.',
      'Sepse abdominal e peritonite séptica com controle cirúrgico de foco.',
      'Profilaxia antimicrobiana cirúrgica parenteral em procedimentos contaminados.',
    ],
  }),
  medicationListCard({
    ...
    isControlled: false,
    tradeNames: [
      'Elura™ 20 mg/mL Solução Oral para Gatos (Elanco Brasil)',
      'Entyce® 30 mg/mL Solução Oral para Cães (Elanco EUA)',
    ],
    pharmacologicClass: 'Agonista seletivo do receptor da grelina (GHSR1a); secretagogo do hormônio do crescimento (GH)',
    species: ['cat', 'dog'],
    category: 'endocrinologia',
    tags: [
      'Capromorelina',
    ...
    indications: [
      'Manejo da perda ponderal e hiporexia em gatos com Doença Renal Crônica (Recomendação IRIS 2026).',
      'Estimulação voluntária do apetite e reversão de perda de peso em cães inapetentes.',
      'Suporte multimodal contra caquexia e perda muscular crônica em felinos idosos.',
    ],
  }),
  medicationListCard({
    ...
    isControlled: false,
    tradeNames: [
      'Synulox® 50 mg e 250 mg Comprimidos Palatáveis (Zoetis — Proporção 4:1)',
      'Agemoxi CL® 50 mg e 250 mg Comprimidos (Agener União — 4:1)',
      'Clavulin® 500/125 mg (4:1) e 875/125 mg (7:1) (GSK / Genéricos Humanos)',
    ],
    pharmacologicClass: 'Antibacteriano bactericida; aminopenicilina potencializada por inibidor suicida de beta-lactamases (4:1)',
    species: ['dog', 'cat'],
    category: 'infectologia',
    tags: [
      'Amoxicilina',
    ...
    indications: [
      'Piodermite canina superficial com falha tópica ou piodermite profunda por MSSP (ISCAID 2025).',
      'Feridas contaminadas por mordeduras e abscessos subcutâneos polimicrobianos.',
      'Cistite bacteriana esporádica com confirmação por antibiograma em cursos curtos de 3 a 5 dias.',
      'Adjuvante em procedimentos cirúrgicos periodontais e extrações dentárias.',
    ],
  }),
  medicationListCard({
    ...
    activeIngredient: 'Sulfadiazina / Sulfametoxazol + Trimetoprima (1:5)',
    isControlled: false,
    tradeNames: [
      'Ibatrim Oral® Solução 240 mg/mL (IBASA — Uso Veterinário Oficial)',
      'Bactrim® Comprimidos 480 mg e 960 mg (Roche / Genéricos Humanos)',
      'Bactrim® Suspensão Oral 48 mg/mL (Roche / Genéricos Humanos)',
    ],
    pharmacologicClass: 'Antibacteriano e antiprotozoário bactericida; sulfonamida potencializada por diaminopirimidina (1:5)',
    species: ['dog', 'cat'],
    category: 'infectologia',
    tags: [
      'Trimetoprima',
    ...
    indications: [
      'Cistite bacteriana esporádica canina e felina em cursos curtos de 3 a 5 dias (ISCAID UTI).',
      'Prostatite bacteriana canina aguda e crônica por aprisionamento iônico no ácino prostático.',
      'Piodermite bacteriana canina como antimicrobiano de segunda escolha segundo o consenso ISCAID 2025.',
      'Nocardiose cutânea e sistêmica e protozooses (Toxoplasma e Neospora) em pequenos animais.',
    ],
  }),
  medicationListCard({
    id: 'med-clindamicina',
    slug: 'clindamicina',
    title: 'Clindamicina',
    activeIngredient: 'Cloridrato / Fosfato / Palmitato de Clindamicina',
    isControlled: false,
    tradeNames: [
      ...
      'Fosfato de Clindamicina 150 mg/mL Injetável (Pfizer / Genéricos)',
    ],
    pharmacologicClass: 'Antibacteriano e antiprotozoário da classe das lincosamidas (inibidor ribossomal 50S e do apicoplasto)',
    species: ['dog', 'cat'],
    category: 'infectologia',
    tags: [
      'Clindamicina',
    ...
    indications: [
      'Piodermite bacteriana canina sistêmica em falhas tópicas (ISCAID 2025).',
      'Osteomielite bacteriana canina aguda e crônica com alta penetração óssea (Braden et al.).',
      'Abscessos, celulites, feridas por mordeduras e infecções periodontais.',
      'Toxoplasmose clínica felina (mínimo de 4 semanas) e neosporose canina precoce.',
    ],
  }),
  medicationListCard({
    ...
    activeIngredient: 'Hidróxido de Alumínio [Al(OH)3]',
    isControlled: false,
    tradeNames: [
      'Hidróxido de Alumínio Pó Seco USP (Grau Farmacêutico Puro sem Flavorizantes)',
      'Hidróxido de Alumínio Suspensão Oral 60 mg/mL (6% Humana)',
      'Hidróxido de Alumínio Pasta / Suspensão Manipulada 100 mg/mL',
      'Pepsamar® Suspensão Oral (Referência Humana)',
    ],
    pharmacologicClass: 'Quelante / ligante intestinal de fosfato inorgânico e antiácido neutralizante local',
    species: ['dog', 'cat'],
    category: 'nefrologia',
    tags: [
    ...
    indications: [
      'Hiperfosfatemia refratária à dieta renal em cães e gatos com Doença Renal Crônica (estágios 2, 3 e 4 IRIS).',
      'Adsorção intraluminal de fosfato dietético, prevenindo hiperparatireoidismo secundário renal e calcificação metastática.',
      'Antiácido neutralizante de curta ação para alívio sintomático rápido de hiperacidez e gastrite urêmica.',
    ],
  }),
  medicationListCard({
    id: 'med-pronefra',
    slug: 'pronefra',
    title: 'Pronefra®',
    activeIngredient: 'Carbonato de Cálcio + Carbonato de Magnésio + Quitosana + Hidrolisado de Proteína de Peixe',
    isControlled: false,
    tradeNames: [
      'Pronefra® Suspensão Oral 60 mL (Virbac — Uso Veterinário Oficial)',
    ],
    pharmacologicClass: 'Suplemento nutricional renal; quelante mineral intestinal de fósforo e adsorvente entérico de toxinas urêmicas',
    species: ['dog', 'cat'],
    category: 'nefrologia',
    tags: [
      'Pronefra',
