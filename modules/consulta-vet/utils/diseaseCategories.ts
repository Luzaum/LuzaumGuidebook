...
const CATEGORY_ALIASES: Record<string, string> = {
  ...
  'cirurgia-neurologica': 'neurologia',
  'cirurgia-neuro': 'neurologia',
  imunologia: 'hematologia',
  'emergencia-uti': 'intensivismo',
  'emergencia-intensivismo': 'intensivismo',
  emergencia: 'intensivismo',
  uti: 'intensivismo',
  'reproducao-neonatologia': 'reproducao-obstetricia',
  reproducao: 'reproducao-obstetricia',
  obstetricia: 'reproducao-obstetricia',
  'clinica-medica': 'hematologia',
