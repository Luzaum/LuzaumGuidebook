...
const TOPIC_ICONS: Record<string, LucideIcon> = {
  ...
  figuraCicloCarrapato: LayoutGrid,
  ...
  epistaxe: Droplets,
  hifema: Eye,
  hemorragiaEscleral: Eye,
  planoDiagnostico: ListOrdered,
  fasesELaboratorio: Table2,
  morulaTvmdl: Microscope,
  morulaDetalhada: Microscope,
  antimicrobianos: Pill,
  mielossupressao: Droplets,
};
