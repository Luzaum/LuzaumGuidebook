...
export const MEDICATION_THERAPEUTIC_CLASSES: readonly MedicationTherapeuticClass[] = [
  ...
  },
  {
    ...
    medicationSlugs: ['fenobarbital', 'pregabalina', 'selegilina', 'fluoxetina', 'amitriptilina'],
    keywords: ['anticonvulsivante', 'antiepiléptico', 'dor neuropática', 'neurológico'],
  },
  {
    slug: 'diureticos-hiperosmolares',
    label: 'Diuréticos e agentes hiperosmolares',
    ...
    keywords: ['diurético osmótico', 'hiperosmolar', 'manitol', 'pressão intracraniana', 'edema cerebral'],
  },
  {
    slug: 'antiemeticos',
    label: 'Antieméticos',
