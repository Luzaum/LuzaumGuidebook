...
export function MedicationPharmacokineticsSection({
  ...
  return (
    <section id="farmacocinetica" className="consulta-vet-readable-highlights scroll-mt-24 rounded-3xl border border-border bg-card p-6 sm:p-8 shadow-xs space-y-6">
