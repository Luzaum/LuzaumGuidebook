    ...
    >
      <div className="relative z-10 flex h-full min-h-0 w-full flex-1">
        ...
        <div className="consulta-vet-content-panel relative flex min-h-0 flex-1 flex-col overflow-hidden">
          ...
          <main
            ref={contentRootRef}
            className="consulta-vet-main-scroll relative flex min-h-0 flex-1 flex-col overflow-y-auto overscroll-y-contain"
          >
            <ConsultaVetErrorBoundary>
              <Outlet />
            </ConsultaVetErrorBoundary>
          </main>
          <ClinicalAcronymGlossaryV2 contentRoot={contentRootRef} />
        </div>
      </div>
    </AuroraBackground>
  );
