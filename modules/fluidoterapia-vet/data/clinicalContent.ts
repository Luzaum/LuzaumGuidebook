...
export const resuscitationPresets: ResuscitationPreset[] = [
  ...
  },
  {
    ...
    why: ['TCE pede euvolemia e pressão adequadas.', 'Se houver indicação osmoterápica, avaliar o protocolo apropriado.'],
...
export const protocols: ProtocolContent[] = [
  ...
  },
  {
    ...
    preferred: ['Cristaloide isotônico para euvolemia.', 'Solução hipertônica ou manitol conforme o contexto e o protocolo de osmoterapia.'],
  ...
  },
  {
    id: 'hypernatremia',
    title: 'Hipernatremia',
    summary: 'Correção lenta e calculada, com free water déficit como helper quando fizer sentido.',
    ...
    preferred: ['Usar free water déficit como ajuda, não piloto automático.', 'Ajustar com contexto e laboratório real.'],
