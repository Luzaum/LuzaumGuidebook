...
export const TOOLTIP = {
  ...
  repetir_periodicamente: 'Após dose única, repetir no intervalo definido (ex.: a cada 12 semanas).',
  modo_frequencia: 'Define como a frequencia e expressa: vezes por dia, intervalo em horas, dose única ou repeticao.',
  ...
  dose_final_administracao: 'Quantidade final por administração calculada para o paciente.',
  indicacao_clinica: 'Situacao clínica para a qual o item e indicado.',
