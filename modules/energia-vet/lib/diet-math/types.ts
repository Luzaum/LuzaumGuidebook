...
export interface NutritionPatientAssessment {
  ...
  /** Perfil FEDIAF v3 explícito quando o clínico seleciona card na etapa Energia. */
  dogEnergyProfileOverride?:
    | 'low_activity'
    | 'moderate_low_impact'
    ...
    | 'age_3_7'
    | 'senior'
  catEnergyProfileOverride?: 'indoor_neutered' | 'active'
  /** ID do perfil energético selecionado na UI (livro/FEDIAF). */
