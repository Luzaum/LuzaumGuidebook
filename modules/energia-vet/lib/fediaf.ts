...
export const FEDIAF_REQUIREMENT_PROFILES: RequirementProfile[] = [
  buildProfile({ id: 'fediaf-dog-early-growth-1000kcal', label: 'Referência nutricional - cão em crescimento/reprodução', species: 'dog', lifeStage: 'early_growth_reproduction', condition: 'fediaf_principal', basisType: 'per_1000kcal', page: 73, table: 'VII-17a', nutrientTargets: DOG_EARLY_GROWTH_1000KCAL }),
  buildProfile({ id: 'fediaf-dog-early-growth-dm', label: 'FEDIAF Cão - crescimento precoce/reproducao - %MS', species: 'dog', lifeStage: 'early_growth_reproduction', condition: 'fediaf_principal', basisType: 'percent_dm', page: 73, table: 'VII-17a', nutrientTargets: DOG_EARLY_GROWTH_DM }),
  buildProfile({ id: 'fediaf-dog-late-growth-1000kcal', label: 'Referência nutricional - cão em crescimento tardio', species: 'dog', lifeStage: 'late_growth', condition: 'fediaf_principal', basisType: 'per_1000kcal', page: 74, table: 'VII-17b', nutrientTargets: DOG_LATE_GROWTH_1000KCAL }),
  buildProfile({ id: 'fediaf-dog-late-growth-dm', label: 'FEDIAF Cão - crescimento tardio - %MS', species: 'dog', lifeStage: 'late_growth', condition: 'fediaf_principal', basisType: 'percent_dm', page: 74, table: 'VII-17b', nutrientTargets: DOG_LATE_GROWTH_DM }),
  buildProfile({ id: 'fediaf-dog-adult-110-1000kcal', label: 'Referência nutricional - cão adulto manutenção', species: 'dog', lifeStage: 'adult_maintenance', condition: 'normal_activity', basisType: 'per_1000kcal', page: 75, table: 'VII-17c', nutrientTargets: DOG_ADULT_110_1000KCAL }),
  buildProfile({ id: 'fediaf-dog-adult-110-dm', label: 'Referência nutricional - cão adulto manutenção (%MS)', species: 'dog', lifeStage: 'adult_maintenance', condition: 'normal_activity', basisType: 'percent_dm', page: 75, table: 'VII-17c', nutrientTargets: DOG_ADULT_110_DM }),
  buildProfile({ id: 'fediaf-dog-adult-95-1000kcal', label: 'Referência nutricional - cão adulto com baixa atividade', species: 'dog', lifeStage: 'adult_maintenance', condition: 'low_activity_or_obese_prone', basisType: 'per_1000kcal', page: 76, table: 'VII-17d', nutrientTargets: DOG_ADULT_95_1000KCAL }),
  buildProfile({ id: 'fediaf-dog-adult-95-dm', label: 'Referência nutricional - cão adulto com baixa atividade (%MS)', species: 'dog', lifeStage: 'adult_maintenance', condition: 'low_activity_or_obese_prone', basisType: 'percent_dm', page: 76, table: 'VII-17d', nutrientTargets: DOG_ADULT_95_DM }),
  buildProfile({ id: 'fediaf-cat-growth-1000kcal', label: 'Referência nutricional - gato em crescimento/reprodução', species: 'cat', lifeStage: 'growth_reproduction', condition: 'fediaf_principal', basisType: 'per_1000kcal', page: 77, table: 'VII-18a', nutrientTargets: CAT_GROWTH_1000KCAL }),
  ...
  buildProfile({ id: 'fediaf-cat-adult-100-1000kcal', label: 'Referência nutricional - gato adulto ativo', species: 'cat', lifeStage: 'adult_maintenance', condition: 'active', basisType: 'per_1000kcal', page: 78, table: 'VII-18b', nutrientTargets: CAT_ADULT_100_1000KCAL }),
  ...
  buildProfile({ id: 'fediaf-cat-adult-75-1000kcal', label: 'Referência nutricional - gato adulto castrado/indoor', species: 'cat', lifeStage: 'adult_maintenance', condition: 'neutered_or_indoor', basisType: 'per_1000kcal', page: 79, table: 'VII-18c', nutrientTargets: CAT_ADULT_75_1000KCAL }),
  ...
  buildProfile({ id: 'fediaf-dog-adult-metabolic', label: 'FEDIAF Cão adulto manutenção - por peso metabólico', species: 'dog', lifeStage: 'adult_maintenance', condition: 'metabolic_reference', basisType: 'per_metabolic_bw', page: 58, table: 'VII-11', nutrientTargets: DOG_ADULT_METABOLIC }),
  buildProfile({ id: 'fediaf-cat-adult-metabolic', label: 'FEDIAF Gato adulto manutenção - por peso metabólico', species: 'cat', lifeStage: 'adult_maintenance', condition: 'metabolic_reference', basisType: 'per_metabolic_bw', page: 58, table: 'VII-11', nutrientTargets: CAT_ADULT_METABOLIC }),
]

export const FEDIAF_PHYSIOLOGIC_STATES: PhysiologicState[] = [
  { id: 'dog_young_adult_1_2', label: 'Jovem adulto 1-2 anos', species: 'dog', category: 'Adulto', minFactor: 130 / 90, maxFactor: 130 / 90, defaultFactor: 130 / 90, calculationMode: 'kcal_per_metabolic_bw', minKcalPerMetabolicBw: 125, maxKcalPerMetabolicBw: 140, defaultKcalPerMetabolicBw: 130, defaultRequirementProfileId: 'fediaf-dog-adult-110-1000kcal', explanation: 'Tabela VII-6: MER medio para cães de 1 a 2 anos.', source: 'FEDIAF 2025', clinicalObservation: 'Usar como ponto de partida e reajustar por condicao corporal.', sourceReference: { document: 'FEDIAF Nutritional Guidelines 2025', pages: [54], tables: ['VII-6'] } },
  ...
  { id: 'cat_lactation', label: 'Lactacao', species: 'cat', category: 'Reproducao', minFactor: 0, maxFactor: 0, defaultFactor: 0, calculationMode: 'cat_lactation', requiresLitterSize: true, requiresLactationWeek: true, defaultRequirementProfileId: 'fediaf-cat-growth-1000kcal', explanation: 'Tabela VII-10: fórmula varia por numero de filhotes e semana de lactacao.', source: 'FEDIAF 2025', clinicalObservation: 'Na lactacao, a checagem do consumo real e essencial para evitar perda excessiva de peso.', sourceReference: { document: 'FEDIAF Nutritional Guidelines 2025', pages: [57], tables: ['VII-10'] } },
]
