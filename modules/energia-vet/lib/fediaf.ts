...
export const FEDIAF_REQUIREMENT_PROFILES: RequirementProfile[] = [
  buildProfile({ id: 'fediaf-dog-early-growth-1000kcal', label: 'FEDIAF Cão - crescimento precoce/reproducao - por 1000 kcal', species: 'dog', lifeStage: 'early_growth_reproduction', condition: 'fediaf_principal', basisType: 'per_1000kcal', page: 73, table: 'VII-17a', nutrientTargets: DOG_EARLY_GROWTH_1000KCAL }),
  ...
  buildProfile({ id: 'fediaf-dog-late-growth-1000kcal', label: 'FEDIAF Cão - crescimento tardio - por 1000 kcal', species: 'dog', lifeStage: 'late_growth', condition: 'fediaf_principal', basisType: 'per_1000kcal', page: 74, table: 'VII-17b', nutrientTargets: DOG_LATE_GROWTH_1000KCAL }),
  ...
  buildProfile({ id: 'fediaf-dog-adult-110-1000kcal', label: 'FEDIAF Cão adulto 110 kcal/kg^0.75 - por 1000 kcal', species: 'dog', lifeStage: 'adult_maintenance', condition: 'normal_activity', basisType: 'per_1000kcal', page: 75, table: 'VII-17c', nutrientTargets: DOG_ADULT_110_1000KCAL }),
  buildProfile({ id: 'fediaf-dog-adult-110-dm', label: 'FEDIAF Cão adulto 110 kcal/kg^0.75 - %MS', species: 'dog', lifeStage: 'adult_maintenance', condition: 'normal_activity', basisType: 'percent_dm', page: 75, table: 'VII-17c', nutrientTargets: DOG_ADULT_110_DM }),
  buildProfile({ id: 'fediaf-dog-adult-95-1000kcal', label: 'FEDIAF Cão adulto 95 kcal/kg^0.75 - por 1000 kcal', species: 'dog', lifeStage: 'adult_maintenance', condition: 'low_activity_or_obese_prone', basisType: 'per_1000kcal', page: 76, table: 'VII-17d', nutrientTargets: DOG_ADULT_95_1000KCAL }),
  buildProfile({ id: 'fediaf-dog-adult-95-dm', label: 'FEDIAF Cão adulto 95 kcal/kg^0.75 - %MS', species: 'dog', lifeStage: 'adult_maintenance', condition: 'low_activity_or_obese_prone', basisType: 'percent_dm', page: 76, table: 'VII-17d', nutrientTargets: DOG_ADULT_95_DM }),
