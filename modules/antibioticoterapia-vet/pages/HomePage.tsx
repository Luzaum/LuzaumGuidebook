      ...
      <section className="abv-hero relative min-h-[min(52vh,420px)]">
        ...
        <div className="abv-hero-content mx-auto flex max-w-5xl flex-col px-4 pb-8 pt-10 md:pb-10 md:pt-14">
          <header className="mb-8 text-center md:mb-10">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-pretty text-base md:text-lg" style={{ color: 'hsl(var(--muted-foreground))' }}>
          ...
          <form onSubmit={submit}>
            ...
            <div className="abv-panel mx-auto flex max-w-2xl flex-col gap-2 p-2 shadow-md md:flex-row md:items-center">
              <div className="flex flex-1 items-center gap-2 px-3">
                <Search className="h-5 w-5 shrink-0" style={{ color: 'hsl(var(--primary))' }} aria-hidden />
                <input
            ...
            <p className="mt-2 text-center text-xs" style={{ color: 'hsl(var(--muted-foreground))' }}>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            >
              ...
              <span className="mt-1 text-sm" style={{ color: 'hsl(var(--muted-foreground))' }}>
                Conduta por síndrome enquanto o novo catálogo é integrado.
              </span>
              <span className="mt-3 inline-flex items-center gap-1 text-sm font-medium" style={{ color: 'hsl(var(--primary))' }}>
            ...
            >
              <span className="mb-3 inline-flex h-11 w-11 items-center justify-center rounded-md abv-badge-soft">
                <Pill className="h-6 w-6" style={{ color: 'hsl(var(--primary))' }} />
              </span>
              <span className="font-semibold" style={{ color: 'hsl(var(--foreground))' }}>
                Antimicrobianos
              </span>
            ...
            >
              <span className="mb-3 inline-flex h-11 w-11 items-center justify-center rounded-md abv-badge-soft">
                <Scissors className="h-6 w-6" style={{ color: 'hsl(var(--secondary))' }} />
              </span>
              <span className="font-semibold" style={{ color: 'hsl(var(--foreground))' }}>
                Perioperatório
              </span>
          ...
          <footer className="mt-10 text-center">
            <p className="abv-panel mx-auto max-w-2xl px-4 py-3 text-xs shadow-sm" style={{ color: 'hsl(var(--muted-foreground))' }}>
