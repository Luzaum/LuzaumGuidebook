...
export const NAME_ALIASES: { [key: string]: string } = {
  ...
  // Others
  'Penicilina G': 'Penicilina G (Benzilpenicilina)',
  ...
  'Ácido Fusídico': 'Ácido Fusídico (Tópico)',
  'Ácido Fusídico (Tópico)': 'Ácido Fusídico (Tópico)',
  ...
  'Febantel': 'Febantel + Pirantel + Praziquantel',
  'Febantel + Pirantel + Praziquantel': 'Febantel + Pirantel + Praziquantel',
  'Itraconazol': 'Itraconazol',
  'Iodeto de Potassio': 'Iodeto de Potássio',
  'Iodeto de Potássio': 'Iodeto de Potássio',
  'Iodeto': 'Iodeto de Potássio',
  'Acido Fusidico': 'Ácido Fusídico (Tópico)',
  'Clorexidina': 'Clorexidina (Tópico)',
  'Clorexidina (Tópico)': 'Clorexidina (Tópico)',
  'Imidocarb': 'Imidocarb',
};
...
export const DISEASE_ALIASES: { [key: string]: string } = {
  ...
  pio: 'Piometra',
  piometrite: 'Piometra',
  sepse: 'Sepse de origem desconhecida / Choque Séptico',
  choque: 'Sepse de origem desconhecida / Choque Séptico',
  'choque septico': 'Sepse de origem desconhecida / Choque Séptico',
  pneumonia: 'Pneumonia Bacteriana Comunitária',
  pneumo: 'Pneumonia Bacteriana Comunitária',
  'pneumonia aspirativa': 'Pneumonia Aspirativa',
  piotorax: 'Piotórax / Pleurite Purulenta',
  piotórax: 'Piotórax / Pleurite Purulenta',
  cistite: 'Cistite Esporádica (ITU Não Complicada)',
  'cistite esporadica': 'Cistite Esporádica (ITU Não Complicada)',
  'cistite recorrente': 'Cistite Recorrente',
  pielonefrite: 'Infecções no Trato Urinário Superior / Pielonefrite',
  pyelonefrite: 'Infecções no Trato Urinário Superior / Pielonefrite',
  'itu alta': 'Infecções no Trato Urinário Superior / Pielonefrite',
  pielo: 'Infecções no Trato Urinário Superior / Pielonefrite',
  'bacteriuria subclinica': 'Bacteriúria Subclínica',
  'bacteriuria': 'Bacteriúria Subclínica',
  urolitiase: 'Infecções Urinárias Associadas a Urolitíases',
  urolitíase: 'Infecções Urinárias Associadas a Urolitíases',
  'cistite nosocomial': 'Cistite Nosocomial (Infecção Hospitalar) e Cateter Urinário',
  cateter: 'Cistite Nosocomial (Infecção Hospitalar) e Cateter Urinário',
  rinite: 'Infecção Aguda de Vias Aéreas Superiores / Rinite Aguda (<10 dias)',
  'rinite aguda': 'Infecção Aguda de Vias Aéreas Superiores / Rinite Aguda (<10 dias)',
  'rinite cronica': 'Infecção Crônica de Vias Aéreas Superiores / Rinite Crônica (>10 dias)',
  'tosse dos canis': 'Traqueobronquite Infecciosa Canina / Tosse dos Canis',
  traqueite: 'Traqueobronquite Infecciosa Canina / Tosse dos Canis',
  bronquite: 'Traqueobronquite Infecciosa Canina / Tosse dos Canis',
  vaginite: 'Vaginite Infantil e em Adultas',
  'vaginite infantil': 'Vaginite Infantil e em Adultas',
  metrite: 'Metrite Aguda Puerperal',
  endometrite: 'Endometrite',
  prostatite: 'Prostatite Aguda e Crônica',
  mastite: 'Mastite',
  cesariana: 'Cesariana (Indicação em Distocia / Ruptura Uterina)',
  balanopostite: 'Balanopostite',
  orquite: 'Orquite e Epididimite',
  epididimite: 'Orquite e Epididimite',
  gestante: 'Diretrizes para Infecções em Fêmeas Gestantes',
  prenhez: 'Diretrizes para Infecções em Fêmeas Gestantes',
  'cavidade oral': 'Procedimentos em Cavidade Oral e Extração Dentária',
  dentaria: 'Procedimentos em Cavidade Oral e Extração Dentária',
  dentária: 'Procedimentos em Cavidade Oral e Extração Dentária',
  gengivite: 'Gengivite e Periodontite',
  periodontite: 'Gengivite e Periodontite',
  fcgs: 'Gengivoestomatite Crônica Felina (FCGS)',
  gengivostomatite: 'Gengivoestomatite Crônica Felina (FCGS)',
  gastroenterite: 'Gastroenterite Aguda / Diarreia Sanguinolenta (Graus 1, 2 e 3)',
  diarreia: 'Gastroenterite Aguda / Diarreia Sanguinolenta (Graus 1, 2 e 3)',
  ahds: 'Gastroenterite Aguda / Diarreia Sanguinolenta (Graus 1, 2 e 3)',
  parvovirose: 'Parvovirose Canina',
  parvo: 'Parvovirose Canina',
  campylobacter: 'Infecção por Campylobacter spp.',
  clostridium: 'Infecção por Clostridium perfringens Tipo F (netF+)',
  'clostridium perfringens': 'Infecção por Clostridium perfringens Tipo F (netF+)',
  salmonella: 'Infecção por Salmonella sp.',
  salmonelose: 'Infecção por Salmonella sp.',
  giardia: 'Giardíase Canina e Felina',
  giardiase: 'Giardíase Canina e Felina',
  giardíase: 'Giardíase Canina e Felina',
  gastrite: 'Gastrite Aguda e Crônica',
  dii: 'Doença Inflamatória Intestinal (DII) e Disbiose',
  disbiose: 'Doença Inflamatória Intestinal (DII) e Disbiose',
  'colite histiocitica': 'Colite Ulcerativa Histiocítica / Granulomatosa',
  pancreatite: 'Pancreatite Aguda',
  'artrite septica': 'Artrite Séptica',
  artrite: 'Artrite Séptica',
  osteomielite: 'Osteomielite',
  'piodermite de superficie': 'Piodermite de Superfície',
  'piodermite superficial': 'Piodermite Superficial Canina',
  'piodermite profunda': 'Piodermite Profunda Canina',
  mordedura: 'Feridas por Mordedura',
  mordida: 'Feridas por Mordedura',
  feridas: 'Infecções de Feridas, Tecidos Moles e Abscessos',
  abscesso: 'Infecções de Feridas, Tecidos Moles e Abscessos',
  leptospirose: 'Leptospirose Canina',
  lepto: 'Leptospirose Canina',
  erliquiose: 'Erliquiose Canina e Anaplasmose',
  ehrlichia: 'Erliquiose Canina e Anaplasmose',
  anaplasma: 'Erliquiose Canina e Anaplasmose',
  esporotricose: 'Esporotricose Felina',
  esporo: 'Esporotricose Felina',
  meningite: 'Meningite Bacteriana',
  profilaxia: 'Profilaxia Cirúrgica Perioperatória',
  perioperatorio: 'Profilaxia Cirúrgica Perioperatória',
};
...
export const CLASS_STYLE: { [key: string]: ClassStyle } = {
  ...
  nitrofurano: {emoji:'🟡', bg:'rgba(234, 179, 8, 0.12)', border:'rgba(234, 179, 8, 0.5)'},
  antifungico: {emoji:'🍄', bg:'rgba(236, 72, 153, 0.12)', border:'rgba(236, 72, 153, 0.5)'},
  antiprotozoario: {emoji:'🔬', bg:'rgba(245, 158, 11, 0.12)', border:'rgba(245, 158, 11, 0.5)'},
  topico: {emoji:'🧴', bg:'rgba(14, 165, 233, 0.12)', border:'rgba(14, 165, 233, 0.5)'},
  gastroprotetor: {emoji:'💊', bg:'rgba(16, 185, 129, 0.12)', border:'rgba(16, 185, 129, 0.5)'}
};
