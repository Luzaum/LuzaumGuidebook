...
const PATTERNS: PatternDef[] = [
  ...
  { regex: /(?:BE|Base\s*Excess|SBE|ABE|d[eé]ficit\s*de\s*base|Excesso\s*de\s*base|BE\(ecf\)|BE\(B\)|BEB)\s*[:=.\-]*\s*([-+]?\d+[.,]\d+|[-+]?\d+)/gi, key: 'BE', name: 'Excesso de bases' },
  { regex: /(?:sO2|SatO2|SaO2|SO2|Satura[çc][ãa]o\s*(?:de\s*)?O2|Sat\s*O2)\s*[:=.\-]*\s*([-+]?\d+[.,]\d+|[-+]?\d+)/gi, key: 'sO2', name: 'SatO2' },
  { regex: /(?:Na\+?|S[óo]dio|Sodium)\s*[:=.\-]*\s*([-+]?\d+[.,]\d+|[-+]?\d+)/gi, key: 'Na', name: 'Sódio' },
  { regex: /(?:K\+?|Pot[aá]ssio|Potassium)\s*[:=.\-]*\s*([-+]?\d+[.,]\d+|[-+]?\d+)/gi, key: 'K', name: 'Potássio' },
  ...
  { regex: /(?:iCa|Ca\+\+|C[aá]lcio\s*ionizado|ionized\s*calcium|Ca\s*ion)\s*[:=.\-]*\s*([-+]?\d+[.,]\d+|[-+]?\d+)/gi, key: 'iCa', name: 'Cálcio ionizado' },
  { regex: /(?:tCa|C[aá]lcio\s*total|Ca\s*Total|Total\s*Calcium)\s*[:=.\-]*\s*([-+]?\d+[.,]\d+|[-+]?\d+)/gi, key: 'tCa', name: 'Cálcio total' },
