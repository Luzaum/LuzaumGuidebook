...
export const Dashboard: React.FC<DashboardProps> = ({ onNavigate }) => {
    ...
    return (
        <div className="bg-aap-background-light text-slate-800 antialiased overflow-hidden h-screen flex relative w-full">
            {/* Sidebar */}
            <aside className="w-64 h-full flex flex-col justify-between glass-sidebar shrink-0 z-20 transition-all duration-300">
                <div className="flex flex-col h-full">
                    <div className="p-6 flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-slate-900 text-lg font-bold leading-none tracking-tight">AAP2 Vetius</h1>
                            <p className="text-aap-primary text-xs font-medium mt-1">Toxicologia Veterinária</p>
                        </div>
                    </div>
                    ...
                    <div className="p-4 border-t border-slate-200/60 bg-white/50">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                                <p className="text-sm font-bold text-slate-900 truncate">Dr. Julia Santos</p>
            ...
            <main className="flex-1 flex flex-col h-full overflow-hidden relative">
                ...
                <header className="flex items-center justify-between px-8 py-5 glass-panel border-b-0 border-l-0 border-r-0 border-t-0 z-10 shrink-0 sticky top-0">
                    <div className="flex items-center gap-4 flex-1">
                        <h2 className="text-2xl font-bold text-slate-800 tracking-tight hidden md:block">Visual Identification Hub</h2>
                        <div className="max-w-md w-full ml-8 relative group">
                            ...
                            <input
                                className="block w-full pl-10 pr-3 py-2.5 border-none rounded-xl bg-white/60 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-aap-primary/20 focus:bg-white transition-all shadow-sm text-sm"
                    ...
                    <div className="flex items-center gap-4">
                        <button className="relative p-2 rounded-lg text-slate-500 hover:bg-white/50 hover:text-aap-primary transition-colors">
                ...
                <div className="flex-1 flex flex-col p-8 gap-8 overflow-y-auto">
                    ...
                    <section className="mb-10">
                        <h3 className="text-slate-800 text-lg font-bold mb-5 flex items-center gap-2">
