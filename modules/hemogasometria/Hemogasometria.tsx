...
const Hemogasometria: React.FC<Props> = ({ onBack }) => {
  ...
  const [inputs, setInputs] = useState<BloodGasInputs>({
    ...
    fio2: 21,
    ph: 0, pco2: 0, hco3: 0, po2: 0, temp: 38.5,
    na: 0, k: 0, cl: 0, albumin: 0,
    glucose: 0, lactate: 0, be: 0
  });
  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden bg-slate-950">
      ...
      <div className="relative z-10 flex flex-col h-screen overflow-hidden">
        {/* Superior Header */}
        <header className="flex items-center justify-between px-8 py-4 bg-white/5 dark:bg-slate-900/50 backdrop-blur-xl border-b border-white/10">
        ...
        <div className="flex-1 flex overflow-hidden">
                   ...
                   {showResults && analysisResult && (
                      <div className="animate-in slide-in-from-bottom-8 duration-700">
                         <div className="flex items-center gap-4 mb-8">
                            ...
                            <h2 className="text-xl font-black uppercase tracking-[0.4em] text-blue-500/80">Relatório Completo</h2>
                            <div className="h-px flex-1 bg-gradient-to-r from-transparent via-blue-500/30 to-transparent"></div>
                         </div>
          ...
          <aside className="w-[450px] flex-shrink-0 animate-in slide-in-from-right-12 duration-500">
