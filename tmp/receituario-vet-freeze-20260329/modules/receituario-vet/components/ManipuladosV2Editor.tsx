...
export function ManipuladosV2Editor(props: ManipuladosV2EditorProps) {
  ...
  return (
    <div className="space-y-5">
      ...
      <RxvCard className="p-5">
        <RxvSectionHeader icon="medication" title="Bloco 2 • Como esse item é prescrito" subtitle="Regime clínico único, com prévia imediata do que vai para a receita." />
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 gap-5 2xl:grid-cols-2">
                ...
                <div className="rounded-2xl border border-slate-800 bg-black/20 p-5">
                  ...
                  <div className="mt-4 grid grid-cols-1 gap-4 xl:grid-cols-2">
                    ...
                    <RxvField label={activeRegimen.frequency_mode === 'times_per_day' ? 'Vezes ao dia' : activeRegimen.frequency_mode === 'interval_hours' ? 'Intervalo' : 'Texto livre'}>
              ...
              <div className="rounded-2xl border border-slate-800 bg-black/20 p-5">
                ...
                <div className="mt-4 space-y-3 text-sm text-slate-300">
                  <p className="font-black text-white">{value.formula.name || 'Fórmula sem nome'}</p>
                  <p>{previewSummary.tutor || 'A posologia final aparecerá aqui conforme o regime.'}</p>
                  <p>{previewSummary.pharmacy || 'A instrução de manipulação aparecerá aqui conforme a fórmula.'}</p>
      ...
      <RxvCard className="p-5">
        ...
        <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
          ...
          <RxvField label="Apresentação final">
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 xl:grid-cols-3">
          ...
          {shouldShowFlavor(value.formula.archetype) ? (
            <RxvField label="Sabor / fragrância">
        ...
        <div className="mt-5 space-y-4">
          {value.ingredients.map((ingredient, index) => {
            ...
            return (
              <div key={ingredient.id} className="rounded-2xl border border-slate-800 bg-black/20 p-4">
                <div className="grid grid-cols-1 gap-4 xl:grid-cols-12">
                  <div className="xl:col-span-4">
        ...
        {activeRegimen ? (
          <div className="mt-5 rounded-2xl border border-slate-800 bg-black/20 p-5">
