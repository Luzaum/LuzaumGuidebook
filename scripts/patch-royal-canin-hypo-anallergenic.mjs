...
const hypoCan = {
  ...
  speciesScope: 'dog',
  foodType: 'commercial',
  presentation: 'Ração seca — HYPOALLERGENIC CANINE (adultos, todos os portes incl. grande)',
  nutrientsAsFed: hypoCanAsFed,
  nutrientsDryMatter: buildDryMatter(hypoCanAsFed),
  missingNutrients: computeMissing(hypoCanAsFed),
  notes: [
    'No Brasil não existe SKU separado "Large Breed"; esta fórmula padrão atende cães adultos de todos os portes.',
...
const hypoSmallAsFed = {
  moisturePct: 11.5,
  dryMatterPct: 88.5,
  energyKcalPer100g: 388.2,
  crudeProteinPct: 22,
  etherExtractPct: 14,
  ashPct: 10.7,
  crudeFiberPct: 2.7,
  nitrogenFreeExtractPct: r6(100 - 11.5 - 22 - 14 - 2.7 - 10.7),
  calciumPct: 0.56,
  phosphorusPct: 0.42,
  potassiumPct: 0.54,
  sodiumPct: 0.618,
  ...
  vitaminEIu: e(360),
  thiamineMg: e(16.44),
  riboflavinMg: e(29.82),
  pyridoxineMg: e(46.02),
  niacinMg: e(295.8),
  pantothenicAcidMg: e(88.2),
  biotinMg: e(1.866),
  folicAcidMg: e(8.28),
  cobalaminMcg: e(84),
  vitaminCMgPerKg: 168,
...
const hypoSmall = {
  id: 'royal-canin-hypoallergenic-small-dog',
  slug: 'royal-canin-hypoallergenic-small-dog',
  ...
  speciesScope: 'dog',
  foodType: 'commercial',
  presentation: 'Ração seca — HYPOALLERGENIC SMALL DOG (até 10 kg)',
  nutrientsAsFed: hypoSmallAsFed,
  nutrientsDryMatter: buildDryMatter(hypoSmallAsFed),
  missingNutrients: computeMissing(hypoSmallAsFed),
  notes: [
    'Alimento coadjuvante seco para cães adultos de pequeno porte (≤ 10 kg).',
    'Contraindicado: pancreatite, gestação e lactação.',
    'Dados: portalvet.royalcanin.com.br (abr 2026).',
  ],
}

// --- Hypoallergenic Moderate Calorie Canine
const hypoModCalAsFed = {
  moisturePct: 11.5,
  dryMatterPct: 88.5,
  energyKcalPer100g: 372.6,
  crudeProteinPct: 21,
  etherExtractPct: 10,
  ashPct: 8.9,
  crudeFiberPct: 3.1,
  nitrogenFreeExtractPct: r6(100 - 11.5 - 21 - 10 - 3.1 - 8.9),
  calciumPct: 0.56,
  phosphorusPct: 0.42,
  potassiumPct: 0.48,
  sodiumPct: 0.24,
  ...
  vitaminEIu: e(360),
  thiamineMg: e(16.5),
  riboflavinMg: e(30.06),
  pyridoxineMg: e(46.26),
  niacinMg: e(297.6),
  pantothenicAcidMg: e(88.68),
  biotinMg: e(1.878),
  folicAcidMg: e(8.34),
  cobalaminMcg: e(84),
  vitaminCMgPerKg: 180,
...
const hypoModCal = {
  id: 'royal-canin-hypoallergenic-moderate-calorie',
  slug: 'royal-canin-hypoallergenic-moderate-calorie',
  name: 'Royal Canin Hypoallergenic Moderate Calorie',
  category: 'Ração',
  categoryNormalized: 'Ração',
  sourceSheet: 'Alimentos MN',
  sourceReference: SOURCE,
  speciesScope: 'dog',
  foodType: 'commercial',
  presentation: 'Ração seca — HYPOALLERGENIC MODERATE CALORIE CANINE',
  nutrientsAsFed: hypoModCalAsFed,
  nutrientsDryMatter: buildDryMatter(hypoModCalAsFed),
  missingNutrients: computeMissing(hypoModCalAsFed),
  notes: [
    'Alimento coadjuvante seco para cães adultos com tendência ao sobrepeso.',
    'Contraindicado: pancreatite aguda, gestação e lactação.',
    'Dados: portalvet.royalcanin.com.br (abr 2026).',
  ],
}
...
const anaCanAsFed = {
  moisturePct: 8.5,
  dryMatterPct: 91.5,
  energyKcalPer100g: 392.4,
  crudeProteinPct: 16,
  etherExtractPct: 14.5,
  ashPct: 9.5,
  crudeFiberPct: 4.3,
  nitrogenFreeExtractPct: r6(100 - 8.5 - 16 - 14.5 - 4.3 - 9.5),
  calciumPct: 0.37,
  phosphorusPct: 0.28,
  potassiumPct: 0.61,
  sodiumPct: 0.41,
  ...
  thiamineMg: e(17.82),
  riboflavinMg: e(29.1),
  pyridoxineMg: e(45.36),
  niacinMg: e(289.8),
  pantothenicAcidMg: e(87.06),
  biotinMg: e(1.7),
  folicAcidMg: e(8.82),
  cobalaminMcg: e(84),
  vitaminCMgPerKg: 132,
...
const anaCan = {
  ...
  slug: 'royal-canin-anallergenic-canine',
  ...
  nutrientsAsFed: anaCanAsFed,
  nutrientsDryMatter: buildDryMatter(anaCanAsFed),
  missingNutrients: computeMissing(anaCanAsFed),
  notes: [
...
const patchList = [hypoFel, anaFel, hypoCan, hypoSmall, hypoModCal, anaCan].map(roundDeep)
