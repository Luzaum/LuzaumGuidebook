new_component2 = """
    return (
        <div className="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-slate-100 min-h-screen flex flex-col w-full">
            <header className="sticky top-0 z-50 flex items-center justify-between border-b border-solid border-slate-200 dark:border-border-dark bg-white/90 dark:bg-[#101623]/90 backdrop-blur-md px-6 py-3 lg:px-10">
                    ...
                    <div className="flex flex-col gap-6 lg:gap-8">
                        ...
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                            ...
                            <div className="flex gap-3">
                                <button className="px-4 py-2 bg-slate-200 dark:bg-card-dark hover:bg-slate-300 dark:hover:bg-border-dark text-slate-700 dark:text-slate-200 rounded-lg font-medium transition-colors flex items-center gap-2" onClick={() => setActiveTab('quiz')}>
                                    <span className="material-symbols-outlined text-sm">school</span> Modo Quiz
                                </button>
                                <button onClick={handleReset} className="px-4 py-2 bg-slate-200 dark:bg-card-dark hover:bg-slate-300 dark:hover:bg-border-dark text-red-600 dark:text-red-400 rounded-lg font-medium transition-colors flex items-center gap-2">
                        ...
                        <form onSubmit={handleAnalyzerSubmit}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 items-start">
                                {/* 1. Patient Info Card */}
                                <section className="bg-white dark:bg-card-dark rounded-xl border border-slate-200 dark:border-border-dark shadow-sm overflow-hidden h-full">
                                    <div className="p-5 border-b border-slate-100 dark:border-border-dark bg-slate-50 dark:bg-card-dark flex items-center gap-3">
                                    ...
                                    <div className="p-5 space-y-4">
                                        <div className="grid grid-cols-2 gap-3 mb-2">
                                            <label className="cursor-pointer group">
                                                ...
                                                <div className="flex flex-col items-center justify-center p-3 rounded-lg border-2 border-slate-200 dark:border-border-dark bg-slate-50 dark:bg-input-dark peer-checked:border-primary dark:peer-checked:border-primary peer-checked:bg-blue-50 dark:peer-checked:bg-primary/10 transition-all">
                                ...
                                <section className="bg-white dark:bg-card-dark rounded-xl border border-slate-200 dark:border-border-dark shadow-sm overflow-hidden h-full">
                                    ...
                                    <div className="p-5 space-y-5">
                                        <div className="space-y-1 relative group">
                                            ...
                                            <PresetsButtons param="ph" species={inputs.species} setInputs={setInputs} />
                                        </div>
                                        <div className="space-y-1 relative group">
                                            <div className="flex justify-between items-center px-1">
                                            ...
                                            <PresetsButtons param="pco2" species={inputs.species} setInputs={setInputs} />
                                        </div>
                                        <div className="space-y-1 relative group">
                                            <div className="flex justify-between items-center px-1">
                                            ...
                                            <PresetsButtons param="po2" species={inputs.species} setInputs={setInputs} />
                                        </div>
                                    </div>
                                </section>
"""

with open(r"c:\PROJETOS VET\Vetius\p2.txt", "w", encoding="utf-8") as f:
    f.write(new_component2)
