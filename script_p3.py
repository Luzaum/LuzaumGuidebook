                                ...
                                <section className="bg-white dark:bg-card-dark rounded-xl border border-slate-200 dark:border-border-dark shadow-sm overflow-hidden h-full">
                                    ...
                                    <div className="p-5 grid grid-cols-2 gap-4">
                                        <div className="space-y-1">
                                            ...
                                            <PresetsButtons param="na" species={inputs.species} setInputs={setInputs} />
                                        </div>
                                        <div className="space-y-1">
                                            ...
                                            <PresetsButtons param="k" species={inputs.species} setInputs={setInputs} />
                                        </div>
                                        <div className="space-y-1">
                                            ...
                                            <PresetsButtons param="cl" species={inputs.species} setInputs={setInputs} />
                                        </div>
                                    </div>
                                </section>
                                ...
                                <section className="bg-white dark:bg-card-dark rounded-xl border border-slate-200 dark:border-border-dark shadow-sm overflow-hidden h-full">
                                    ...
                                    <div className="p-5 space-y-4">
                                        <div className="space-y-1">
                                            ...
                                            <PresetsButtons param="hco3" species={inputs.species} setInputs={setInputs} />
                                        </div>
                                        <div className="space-y-1">
                                            ...
                                            <PresetsButtons param="albumin" species={inputs.species} setInputs={setInputs} />
                                        </div>
                                        <div className="space-y-1">
...
with open(r"c:\PROJETOS VET\Vetius\p3.txt", "w", encoding="utf-8") as f:
    f.write(new_component3)
