 ...
 * EscalasDeDorScreen
 * 
 * Este componente exibe uma página web externa dentro do aplicativo usando um <iframe>.
 * É projetado para integrar a ferramenta de analgesia existente sem precisar recriá-la.
 * 
 ...
 */
const EscalasDeDorScreen = ({ onBack }: { onBack: () => void }) => {
  return (
      ...
      <header className="p-4 bg-white shadow-md flex-shrink-0">
        <div className="flex items-center max-w-4xl mx-auto">
          ...
          <h1 className="text-xl font-bold text-gray-800 ml-4">
            Analgesia e Controle de Dor Veterinária
          </h1>
        </div>
      </header>
...
export default EscalasDeDorScreen;