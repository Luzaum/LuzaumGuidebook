...
export const Layout = ({ children }: { children: React.ReactNode }) => {
  ...
  const menuItems = [
    { icon: <LayoutGrid className="h-5 w-5 flex-shrink-0" />, label: 'Visão Geral', href: '/' },
    { icon: <PawPrint className="h-5 w-5 flex-shrink-0" />, label: 'Pacientes', href: '/patients' },
    { icon: <User className="h-5 w-5 flex-shrink-0" />, label: 'Tutores', href: '/tutors' },
    { icon: <Calendar className="h-5 w-5 flex-shrink-0" />, label: 'Agenda', href: '/calendar' },
    { icon: <DollarSign className="h-5 w-5 flex-shrink-0" />, label: 'Financeiro', href: '/financial' },
    { icon: <PieChart className="h-5 w-5 flex-shrink-0" />, label: 'Análise', href: '/analytics' },
    { icon: <List className="h-5 w-5 flex-shrink-0" />, label: 'Serviços', href: '/services' },
    { icon: <BarChart2 className="h-5 w-5 flex-shrink-0" />, label: 'Relatórios', href: '/reports' },
    { icon: <Settings className="h-5 w-5 flex-shrink-0" />, label: 'Configurações', href: '/settings' },
  ];
