...
export const Dashboard = () => {
  ...
  const quickAccessModules = [
    { title: 'Agenda', icon: Calendar, path: '/calendar', description: 'Gerencie consultas e compromissos.', color: 'bg-blue-500' },
    { title: 'Financeiro', icon: DollarSign, path: '/financial', description: 'Controle de receitas e despesas.', color: 'bg-green-500' },
    { title: 'Serviços', icon: List, path: '/services', description: 'Catálogo de procedimentos e preços.', color: 'bg-orange-500' },
    { title: 'Análises', icon: Activity, path: '/analytics', description: 'Métricas e desempenho da clínica.', color: 'bg-red-500' },
    { title: 'Relatórios', icon: BarChart2, path: '/reports', description: 'Relatórios detalhados para gestão.', color: 'bg-teal-500' },
  ];
      ...
      >
        ...
        <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link to="/calendar" className="text-sm font-medium text-primary hover:underline">Ver Agenda Completa</Link>
          </div>
