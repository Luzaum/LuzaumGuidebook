...
function LandingPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative w-full overflow-x-hidden", children: [
    /* @__PURE__ */ jsxs("section", { className: "relative w-full min-h-screen flex items-end sm:items-center overflow-hidden pb-10 sm:pb-0", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "relative z-10 w-full px-4 sm:px-8 lg:px-16 pointer-events-none h-full flex items-end sm:items-center", children: /* @__PURE__ */ jsxs("div", { className: "w-full sm:max-w-lg md:max-w-xl mr-auto p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl animate-in fade-in slide-in-from-bottom sm:slide-in-from-left duration-700\r\n                          bg-[#0a1532] backdrop-blur-md border border-white/10 sm:border-blue-500/20 shadow-none dark:shadow-[0_8px_32px_rgba(0,0,0,0.24)]", children: [
        /* @__PURE__ */ jsx("div", { className: "pointer-events-auto mb-4 sm:mb-6", children: /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1.5 bg-emerald-500/15 text-emerald-400 border border-emerald-500/25 rounded-full px-3 py-1.5 text-xs font-bold uppercase tracking-widest", children: [
          /* @__PURE__ */ jsx(ShieldCheck, { className: "w-3.5 h-3.5 shrink-0" }),
          "Validado por Especialistas"
        ] }) }),
        /* @__PURE__ */ jsxs("div", { className: "pointer-events-auto", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "hidden sm:flex mt-6 sm:mt-8 pt-5 sm:pt-6 border-t border-white/10 flex-wrap gap-4 sm:gap-5 text-xs sm:text-sm font-medium text-blue-100/80 pointer-events-auto", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(ShieldCheck, { className: "w-4 h-4 sm:w-5 sm:h-5 text-emerald-400 shrink-0" }),
            /* @__PURE__ */ jsx("span", { children: "Validado por Especialistas" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Users, { className: "w-4 h-4 sm:w-5 sm:h-5 text-violet-400 shrink-0" }),
            /* @__PURE__ */ jsx("span", { children: "Comunidade Ativa" })
          ] })
        ] })
      ] }) })
    ] }),
    ...
    /* @__PURE__ */ jsxs("section", { className: "py-16 sm:py-20 lg:py-28 relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center", children: [
        ...
        /* @__PURE__ */ jsxs("h2", { className: "text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4 sm:mb-6 leading-tight", children: [
          ...
          " ",
          /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-to-r from-primary to-purple-400", children: "usu\xE1rios autorizados" })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-base sm:text-lg text-muted-foreground mb-2 sm:mb-3 max-w-xl mx-auto", children: "Os m\xF3dulos cl\xEDnicos do Vetius s\xE3o protegidos. Entre com as credenciais fornecidas para acessar as ferramentas em qualquer dispositivo." }),
