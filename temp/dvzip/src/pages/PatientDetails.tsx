...
export const PatientDetails = () => {
          ...
          <div className="bg-primary/5 rounded-xl border border-primary/20 p-5">
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <Link to={`/tutors/${patient.tutorId}`} className="text-xs text-primary hover:underline">Ver Perfil</Link>
              </div>
            </div>
  ...
  return (
    <div className="space-y-8 max-w-[1600px] mx-auto">
      {/* Top Navigation Bar */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <Link to="/patients" className="inline-flex items-center text-gray-500 hover:text-primary transition-colors text-sm font-medium group">
